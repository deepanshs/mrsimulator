...
# :py:class:`~mrsimulator.signal_processor.apodization.Gaussian` class to perform a
...
# we add a :py:class:`~mrsimulator.signal_processor.apodization.Gaussian` object
