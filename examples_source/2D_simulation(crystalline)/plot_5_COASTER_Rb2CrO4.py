...
# transitions from the following `SpectralEvent` if no `MixingEventA` is defined
# between them. Here, we define a `MixingEventA` with an angle of 109.5 degrees to
    ...
    spectral_dimensions=[
        SpectralDimension(
            ...
            events=[
                ...
                MixingEventA(ch1={"angle": np.pi * 109.5 / 180, "phase": 0}),
            ],
        ),
