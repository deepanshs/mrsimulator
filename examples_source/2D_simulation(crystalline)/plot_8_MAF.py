...
# %%
# Use the generic 2D method, `Method2D`, to simulate a Magic-Angle Flipping (MAF) spectrum
# by customizing the method parameters, as shown below. Note, the Method2D method simulates 
