 ...
 *      res = x + y
 */
static inline void vm_double_add(int count, const double *restrict x, const double *restrict y,
                                 double *restrict res) {
 ...
 *      y += x
 */
static inline void vm_double_add_inplace(int count, const double *restrict x, double *restrict y) {
  // x = __builtin_assume_aligned(x, 32);
  // y = __builtin_assume_aligned(y, 32);
  while (count-- > 0) {
    *y++ += *x++;
 ...
 *      res = x - y
 */
static inline void vm_double_subtract(int count, const double *restrict x, const double *restrict y,
                                      double *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // y = __builtin_assume_aligned(y, 32);
  // res = __builtin_assume_aligned(res, 32);
 ...
 *      res = x * y
 */
static inline void vm_double_multiply(int count, const double *restrict x, const double *restrict y,
                                      double *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // y = __builtin_assume_aligned(y, 32);
  // res = __builtin_assume_aligned(res, 32);
 ...
 *      res = x / y
 */
static inline void vm_double_divide(int count, const double *restrict x, const double *restrict y,
                                    double *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // y = __builtin_assume_aligned(y, 32);
  // res = __builtin_assume_aligned(res, 32);
 ...
 *      res = x * x
 */
static inline void vm_double_square(int count, const double *restrict x, double *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // res = __builtin_assume_aligned(res, 32);
  while (count-- > 0) {
    *res++ = *x * *x;
 ...
 *    res = cos(x)
 */
static inline void vm_double_cosine(int count, const double *restrict x, double *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // res = __builtin_assume_aligned(res, 32);
  while (count-- > 0) {
    *res++ = cos(*x++);
 ...
 *      res = sin(x)
 */
static inline void vm_double_sine(int count, const double *restrict x, double *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // res = __builtin_assume_aligned(res, 32);
  while (count-- > 0) {
    *res++ = sin(*x++);
...
/**
 * Cosine + I Sine of the elements of vector x in rad and stored in res of type complex128.
 *      res = cos(x) + I sin(x)
 */
static inline void vm_cosine_I_sine(int count, const double *restrict x, void *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // res = __builtin_assume_aligned(res, 32);
  double *res_ = (double *)res;
  while (count-- > 0) {
 ...
 *      res = exp(x)
 */
static inline void vm_double_complex_exp(int count, const void *restrict x, void *restrict res) {
  // x = __builtin_assume_aligned(x, 32);
  // res = __builtin_assume_aligned(res, 32);
  double *x_ = (double *)x;
  double *res_ = (double *)res;
 ...
 */
static inline void cblas_dscal(int count, const double a, double *restrict x, const int stride_x) {
  // x = __builtin_assume_aligned(x, 32);
  while (count-- > 0) {
    *x *= a;
    x += stride_x;
 ...
 */
static inline void cblas_zdscal(int count, const double a, void *restrict x, const int stride_x) {
  // x = __builtin_assume_aligned(x, 32);
  double *x_ = (double *)x;
...
static inline void cblas_daxpy(int count, const double a, const double *restrict x,
                               const int stride_x, double *restrict y, const int stride_y) {
  // x = __builtin_assume_aligned(x, 32);
  // y = __builtin_assume_aligned(y, 32);
  while (count-- > 0) {
    *y += a * *x;
