...
extern void mrsimulator_core(
    ...
    float *transition, // Pointer to a transition.
...
extern void __mrsimulator_core(
    ...
    float *transition, MRS_dimension *dimensions, int n_dimension,
    MRS_fftw_scheme *fftw_scheme, MRS_averaging_scheme *scheme, bool interpolation,
    bool *freq_contrib, double *affine_matrix);
