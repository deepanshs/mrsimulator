...
extern void triangle_interpolation1D(double f1, double f2, double f3, double amp,
                                     double *spec, int m0, int iso_intrp);
...
extern void two_d_averaging(double *spec, const int freq_size, double *freq1,
                            ...
                            int dimension0_count, int dimension1_count, int iso_intrp,
                            const int nt, bool user_defined, bool interpolation);

extern void hist1d(double *spec, const int freq_size, double *freq, double *amp, int m);

extern void hist2d(double *spec, const int freq_size, double *freq_1, double *freq_2,
                   double *amp, int amp_stride, int m0, int m1);

extern void generic_2d_triangle_average(double *spec, const int freq_size,
                                        double *freq1, double *freq2, double *amp,
                                        int amp_stride, int m0, int m1,
                                        const int position_size, int32_t *positions,
                                        int iso_intrp);

extern void generic_1d_triangle_average(double *spec, const int freq_size, double *freq,
...
extern void octahedronInterpolation(double *spec, double *freq, const int nt,
                                    double *amp, const int stride, int m);

extern void octahedronInterpolation2D(double *spec, double *freq1, double *freq2,
                                      const int nt, double *amp, const int stride,
                                      int m0, int m1, int iso_intrp);
