 ...
 * @param Lambda_2 A pointer to a complex array of length 5, where the frequency components from
 *      @f${\Lambda'}_{2,n}^{(\sigma)}@f$ is stored ordered as
 ...
 * @param eta The shielding asymmetry, @f$\eta_\sigma \in [-1,1]@f$, defined using Haeberlen
 *      convention.
 * @param Theta A pointer to an array of Euler angles, in radians, of length 3, ordered as
...
static inline void FCF_1st_order_nuclear_shielding_tensor_components(
    double *restrict Lambda_0, void *restrict Lambda_2, const double omega_0_delta_iso_in_Hz,
    const double omega_0_zeta_sigma_in_Hz, const double eta, const double *Theta, const float mf,
    const float mi) {
  ...
  sSOT_1st_order_nuclear_shielding_tensor_components(Lambda_0, Lambda_2, omega_0_delta_iso_in_Hz,
                                                     omega_0_zeta_sigma_in_Hz, eta, Theta);
...
static inline void FCF_1st_order_electric_quadrupole_tensor_components(
  ...
  // Spatial orientation function
  sSOT_1st_order_electric_quadrupole_tensor_components(Lambda_2, spin, Cq_in_Hz, eta, Theta);
...
static inline void FCF_2nd_order_electric_quadrupole_tensor_components(
    double *restrict Lambda_0, void *restrict Lambda_2, void *restrict Lambda_4, const double spin,
    const double v0_in_Hz, const double Cq_in_Hz, const double eta, const double *Theta,
  ...
  // Spatial orientation function
  sSOT_2nd_order_electric_quadrupole_tensor_components(Lambda_0, Lambda_2, Lambda_4, spin, v0_in_Hz,
                                                       Cq_in_Hz, eta, Theta);
...
static inline void FCF_1st_order_weak_J_coupling_tensor_components(
    ...
    const double J_aniso_in_Hz, const double J_eta, const double *Theta, const float mIf,
  ...
  // Spatial orientation function
  sSOT_1st_order_weakly_coupled_J_tensor_components(Lambda_0, Lambda_2, J_iso_in_Hz, J_aniso_in_Hz,
                                                    J_eta, Theta);
