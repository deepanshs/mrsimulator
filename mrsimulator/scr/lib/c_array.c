...
void destroyFloat1DArray(float *arr) { free(arr); }
...
void destroyFloatComplex1DArray(float complex *arr) { free(arr); }
...
void destroyDouble1DArray(double *arr) { free(arr); }
...
void destroyDoubleComplex1DArray(double complex *arr) { free(arr); }
