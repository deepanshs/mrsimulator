...
static PyObject *__pyx_pf_11mrsimulator_7sandbox_pre_phase_components(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_number_of_sidebands, double __pyx_v_sample_rotation_frequency); /* proto */
...
static PyObject *__pyx_pw_11mrsimulator_7sandbox_1pre_phase_components(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_number_of_sidebands,&__pyx_n_s_sample_rotation_frequency,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_sample_rotation_frequency)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_sample_rotation_frequency = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_sample_rotation_frequency == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 14, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_11mrsimulator_7sandbox_pre_phase_components(__pyx_self, __pyx_v_number_of_sidebands, __pyx_v_sample_rotation_frequency);
...
static PyObject *__pyx_pf_11mrsimulator_7sandbox_pre_phase_components(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_number_of_sidebands, double __pyx_v_sample_rotation_frequency) {
  int __pyx_v_n1;
